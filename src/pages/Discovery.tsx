  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 sm:p-6">
      <div className="text-center max-w-2xl w-full">
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-light text-slate-200 mb-2 tracking-wider">
            LEAFNODE
          </h1>
        ...
        {user && (
          <div className="mb-6">
            <Button 
              onClick={signOut}
              variant="outline" 
              className="border-slate-600 text-slate-300 hover:bg-slate-700 bg-transparent focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-900"
            >
              Sign Out
            </Button>
          </div>
