...
import { AdminBooksPanel, AdminTrailersPanel, AdminCachePanel, AdminEventsPanel, AdminPortraitsPanel, AdminAuthorPortraitsPanel } from "@/components/admin";
