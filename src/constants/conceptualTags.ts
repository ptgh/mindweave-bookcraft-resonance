...
export const AUTHOR_GENRE_MAP: Record<string, string> = {
  ...
  "E.E. Smith": "Golden Age",
  "A.E. van Vogt": "Golden Age",
  ...
  "James S.A. Corey": "Space Opera",
  "Larry Niven": "Hard Science Fiction",
  ...
  "Philip Eisner": "Hard Science Fiction",
  "Paul R. Ehrlich (influenced by themes)": "Dystopian Systems",
  "Adrian Tchaikovsky": "Hard Science Fiction",
  "Richard K. Morgan": "Cyberpunk",
  "John Scalzi": "Space Opera",
  "Gene Wolfe": "Dream Logic",
  "N.K. Jemisin": "Dystopian Systems",
  "Emily St. John Mandel": "Dystopian Systems",
  "Walter M. Miller Jr.": "Dystopian Systems",
  "Alfred Bester": "Golden Age",
  "Frederik Pohl": "Golden Age",
  "John Wyndham": "Dystopian Systems",
  "Adam Roberts": "Hard Science Fiction",
  "Larry McCaffery": "Cyberpunk",
  "Garfield Benjamin": "Hard Science Fiction",
  "Hazel Monroe": "Hard Science Fiction",
  "Serena Vaughn": "Hard Science Fiction",
  "Gardner R. Dozois": "Space Opera",
  "Jay Williams": "Golden Age",
  "Michael Mortenson": "Hard Science Fiction",
  "Charles Stross": "Space Opera",
  "Pierce Brown": "Space Opera",
  "Mary Shelley": "Gothic Science Fiction",
  "Jules Verne": "Golden Age",
  "H.G. Wells": "Golden Age",
};
