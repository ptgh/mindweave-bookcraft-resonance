                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {aiRecommendation && (
                      <div className="mt-2 group relative">
                        ...
                        {/* Tooltip on hover */}
                        <div className="absolute left-0 top-full mt-1 w-48 p-3 bg-slate-800/50 border border-slate-700 rounded text-xs text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
