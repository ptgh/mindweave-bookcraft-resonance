  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-20 sm:bottom-24 right-3 sm:right-4 z-30 w-11 h-11 rounded-full bg-slate-900/70 hover:bg-slate-900/90 border border-slate-700/40 hover:border-cyan-400/40 backdrop-blur-md shadow-lg shadow-slate-900/30 transition-all duration-300 hover:scale-105 flex items-center justify-center group"
