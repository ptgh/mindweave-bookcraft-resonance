...
const BookCard = ({ 
  ...
  return (
    <div ref={rootRef} className="bg-slate-900/70 backdrop-blur-lg border border-cyan-400/20 rounded-lg p-4 hover:bg-slate-900/85 hover:border-cyan-400/40 transition-all h-full flex flex-col">
