            ...
            <Card key={film.id} className="bg-card/40 border-border/30 hover:border-amber-400/30 transition-all duration-300 overflow-hidden">
              <div className="p-3">
                ...
                {(film.streaming_availability?.criterion || film.streaming_availability?.apple) && (
                  <div className="flex flex-wrap gap-2 md:gap-1.5 mt-2 pt-2 border-t border-border/20">
                    {film.streaming_availability?.criterion && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 md:gap-1.5 px-1.5 md:px-2 py-1 text-[9px] md:text-[10px] font-medium rounded border transition-all bg-amber-500/10 hover:bg-amber-500/20 border-amber-500/30 text-amber-400"
                        onClick={(e) => e.stopPropagation()}
                      >
                        <img src="/images/criterion-logo.jpg" alt="" className="h-2.5 md:h-3 w-auto rounded-sm" />
                        <span className="hidden sm:inline">Criterion</span>
                    ...
                    {film.streaming_availability?.apple && (
                      ...
                      >
                        ...
                        <span className="hidden sm:inline">Apple TV</span>
                        <ExternalLink className="w-2 h-2 md:w-2.5 md:h-2.5" />
                      </a>
                    )}
                  </div>
