...
const Footer = () => {
  return (
    <footer 
      className="bg-slate-900 mt-auto border-t border-slate-800/50 pb-safe"
      role="contentinfo"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 md:items-center">
          ...
          <div className="flex items-center justify-between md:justify-end gap-4">
            ...
            <a
              ...
              className="text-slate-400 hover:text-cyan-400 transition-colors focus-ring rounded p-2 touch-target-sm order-2 md:order-1"
